...
const HollywoodFirstPost = (req,res) => {
    res.send([
        {
            id:1,
...
const HollywoodTopPost = (req,res) => {
    res.send([
        {
            id:1,
...
module.exports.getHollywoodPost = HollywoodPost;
module.exports.getHollywoodFirstPost = HollywoodFirstPost;
module.exports.getHollywoodTopPost = HollywoodTopPost;